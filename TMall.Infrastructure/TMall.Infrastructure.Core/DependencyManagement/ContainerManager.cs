...
{
    public class ContainerManager : ServiceLocatorImplBase
    {
        ...
        public object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw ExceptionHelper.ThrowComponentException("Unkown dependency");
            ...
            throw ExceptionHelper.ThrowComponentException("尝试创建没有通过控制器注册的对象时，没有找到构造函数.");
        }
        ...
        protected override object DoGetInstance(Type serviceType, string key)
        {
            ...
            return Scope().ResolveNamed(key, serviceType);
        }
    }
